...
public class DslJson<TContext> implements UnknownSerializer {
    ...
    private final ConcurrentHashMap<Class<?>, JsonReader.ReadJsonObject<FastJsonSerializable>> jsonObjectReaders =
            new ConcurrentHashMap<Class<?>, JsonReader.ReadJsonObject<FastJsonSerializable>>();
    ...
    @SuppressWarnings("unchecked")
    protected final JsonReader.ReadJsonObject<FastJsonSerializable> getObjectReader(final Class<?> manifest) {
        try {
            JsonReader.ReadJsonObject<FastJsonSerializable> reader = jsonObjectReaders.get(manifest);
            if (reader == null) {
                try {
                    reader = (JsonReader.ReadJsonObject<FastJsonSerializable>) manifest.getField("JSON_READER").get(null);
                } catch (Exception ignore) {
                    //log error!?
                    return null;
                }
    ...
    public final boolean canSerialize(final Type manifest) {
        ...
        if (manifest instanceof Class<?>) {
            ...
            if (FastJsonSerializable.class.isAssignableFrom(content)) {
                return true;
            }
            if (FastJsonSerializable[].class.isAssignableFrom(content)) {
                return true;
        ...
        if (manifest instanceof ParameterizedType) {
            ...
            if (pt.getActualTypeArguments().length == 1 && pt.getRawType() instanceof Class<?>) {
                ...
                if (container.isArray() || Collection.class.isAssignableFrom(container)) {
                    ...
                    return content instanceof Class<?> && FastJsonSerializable.class.isAssignableFrom((Class<?>) content)
    ...
    public final boolean canDeserialize(final Type manifest) {
        ...
        if (manifest instanceof Class<?>) {
            ...
            if (FastJsonSerializable.class.isAssignableFrom(objectType)) {
            ...
            if (pt.getActualTypeArguments().length == 1 && pt.getRawType() instanceof Class<?>) {
                ...
                if (container.isArray() || Collection.class.isAssignableFrom(container)) {
                    ...
                    if (tryFindReader(content) != null) {
                        ...
                        return FastJsonSerializable.class.isAssignableFrom(objectType) && getObjectReader(objectType) != null;
                    }
                }
            }
        } else if (manifest instanceof GenericArrayType) {
    ...
    public <TResult> TResult deserialize(
        ...
        if (FastJsonSerializable.class.isAssignableFrom(manifest)) {
            final JsonReader.ReadJsonObject<FastJsonSerializable> objectReader = getObjectReader(manifest);
            ...
            if (pt.getActualTypeArguments().length == 1 && pt.getRawType() instanceof Class<?>) {
                ...
                if (container.isArray() || Collection.class.isAssignableFrom(container)) {
                    ...
                    if (contentReader != null) {
                        ...
                        if (FastJsonSerializable.class.isAssignableFrom(contentType)) {
                            final JsonReader.ReadJsonObject<FastJsonSerializable> objectReader = getObjectReader(contentType);
                            if (objectReader != null) {
                                final ArrayList<FastJsonSerializable> result = json.deserializeNullableCollection(objectReader);
                                if (container.isArray()) {
    ...
    public <TResult> List<TResult> deserializeList(
        ...
        if (FastJsonSerializable.class.isAssignableFrom(manifest)) {
            final JsonReader.ReadJsonObject<FastJsonSerializable> reader = getObjectReader(manifest);
            if (reader != null) {
    ...
    public <TResult> TResult deserialize(
        ...
        if (manifest.isArray()) {
            ...
            if (FastJsonSerializable.class.isAssignableFrom(elementManifest)) {
                final JsonReader.ReadJsonObject<FastJsonSerializable> objectReader = getObjectReader(elementManifest);
                if (objectReader != null) {
    ...
    public <T extends FastJsonSerializable> void serialize(final JsonWriter writer, final T[] array) {
        if (array == null) {
            writer.writeNull();
            return;
        }
    ...
    public <T extends FastJsonSerializable> void serialize(final JsonWriter writer, final T[] array, final int len) {
        if (writer == null) {
    ...
    public <T extends FastJsonSerializable> void serialize(final JsonWriter writer, final List<T> list) {
        if (writer == null) {
            throw new IllegalArgumentException("writer can't be null");
        }
        if (list == null) {
    ...
    public <T extends FastJsonSerializable> void serialize(final JsonWriter writer, final Collection<T> collection) {
        if (writer == null) {
            throw new IllegalArgumentException("writer can't be null");
        }
        if (collection == null) {
    ...
    public <T> boolean serialize(final JsonWriter writer, final Type manifest, final Object value) {
        ...
        if (value instanceof FastJsonSerializable) {
            ((FastJsonSerializable) value).serialize(writer, omitDefaults);
            return true;
        }
        if (value instanceof FastJsonSerializable[]) {
        ...
        if (value instanceof Collection) {
            ...
            if (FastJsonSerializable.class.isAssignableFrom(baseType)) {
                serialize(writer, (Collection<FastJsonSerializable>) items);
                return true;
            }
